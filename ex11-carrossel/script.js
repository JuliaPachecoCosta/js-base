...
function nextSlide() {
  currentSlide = (currentSlide + 1) % slides.length // Calcula o ídice do próximo slide
  showSlide(currentSlide) // Exibe o próximo slide 
}

// Função para voltar ao slide anterior
function prevSlide() {
  currentSlide = (currentSlide - 1 + slides.length) % slides.length // Calcula o ídice do próximo slide
